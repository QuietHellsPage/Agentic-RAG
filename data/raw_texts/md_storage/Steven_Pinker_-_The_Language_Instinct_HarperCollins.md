...
This book is about human language. Unlike most books with "language" in the title, it will not chide you about proper usage, trace the
...
What those citations _say_ is another matter. Chomsky gets people
...
The story I will tell in this book has, of course, been deeply influenced by Chomsky. But it is not his story exactly, and I will not tell
...
The ubiquity of complex language among human beings is a gripping discovery and, for many observers, compelling proof that language is innate. But to tough-minded skeptics like the philosopher
...
Bickerton's main evidence comes from a unique historical circumstance. Though the slave plantations that spawned most creoles are,
...
The psycholinguists Jenny Singleton and Elissa Newport have studied a nine-year-old profoundly deaf boy, to whom they gave the
...
Injuries in adulthood are not the only ways that the circuitry underlying language can be compromised. A few otherwise healthy children
...
Another creative scientist, the cognitive psychologist Roger Shepard, had his own moment of sudden visual inspiration, and it led to
...
Note that if the subjects had been manipulating something resembling _verbal descriptions_ of the letters, such as "an upright spine with
...
_floccinaucinihilipilificational:_ pertaining to the categorizing
...
The real rationale for _flied out_ and _Walkmans_ comes from the
...
I'm sick of dealing with all the _Mickey Mouses_ in this administration, [not _Mickey Mice]_
...
A word, in a word, is complicated. But then what in the world _is_
...
The second, very different sense of "word" refers to a rote-memorized chunk: a string of linguistic stuff that is arbitrarily associated
...
The most sophisticated estimate comes from the psychologists William Nagy and Richard Anderson. They began with a list of 227,553
...
Finally, why separate the rabbit from the scurry? Presumably because there are predictable consequences of rabbithood that cut
...
And at the risk of sounding like Andy Rooney on _Sixty Minutes,_
...
Now pronounce _writing_ and _riding._ The _t_ and _d_ have been made
...
The top-down theory of speech perception exerts a powerful emotional tug on some people. It confirms the relativist philosophy that
...
The recent program DragonDictate, mentioned earlier in the chapter, places the burden more on good acoustic, phonological, and
...
Even the less predictable aspects of spelling bespeak hidden linguistic regularities. Consider the following pairs of words where the same
...
The second counterexplanation that one must rule out before attributing a universal of language to a universal language instinct is that
...
A simple example is the word _orange._ Originally it was _norange,_
...
America and England first came to be divided by a common language, in Wilde's memorable words, when colonists and immigrants
...
248 **THE** **L A N G U A G E** **INSTINCT**
...
Recently the archeologist Colin Renfrew has argued that the IndoEuropean takeover was a victory not of the chariot but of the cradle.
...
At this point we enter a territory of fierce controversy but potentially large rewards. Greenberg's hypothesis has been furiously attacked by other scholars of American languages. Comparative
...
And various lumpers from this school have suggested other audacious superphyla and super-superphyla. One comprises Amerind and
...
A correlation between language families and human genetic groupings does _not,_ by the way, mean that there are genes that make it
...
Moving from the highly speculative to the borderline flaky, Shevoroshkin, Ruhlen, and others have been trying to reconstruct words
...
The _Sun_ article is a bit sketchy on the details, but we can surmise
...
More systematic evidence comes from the psychologist Elissa Newport and her colleagues. They tested Korean- and Chinese-born students and faculty at the University of Illinois who had spent at least
...
This inversion (an exaggeration, but a useful one) flips the criticalperiod question with it. The question is no longer "Why does a
...
The solution, from George Williams and P. B. Medawar, is ingenious. As natural selection designed organisms, it must have been
...
Now, Kinsbourne is not suggesting that some primordial rubbernecker literally got its head stuck, but that changes in the genetic
...
Language Organs and Grammar Genes 305
...
Try to stay with me in this neuro-mythological quest: we are beginning to approach the "grammar genes." The molecules that guide,
...
But the discovery is still quite interesting. Most of the languageimpaired family members were average in intelligence, and there are
...
That is why the variation that geneticists tell us about is microscopic—differences in the exact sequence of molecules in proteins
...
To begin with, the apes did _not_ "learn American Sign Language."
...
Even putting aside vocabulary, phonology, morphology, and syntax, what impresses one the most about chimpanzee signing is that
...
The point that the argument misses is that although natural selection involves incremental steps that enhance functioning, the enhancements do not have to be to an existing module. They can slowly build
...
Also unknown is when, in the lineage beginning at the chimphuman common ancestor, proto-language first evolved, or the rate at
...
Modern _Homo sapiens,_ which is thought to have appeared about
...
The scandal of the language mavens began in the eighteenth century. London had become the political and financial center of England, and England had become the center of a powerful empire. The
...
Bernstein's "real reason" for _flied_ is that it has a specialized meaning
...
_Jennifer_ is singular; you say _Jennifer is,_ not _Jennifer are._ The pronoun _She_ is singular; you say _She is,_ not _She are._ But the conjunction
...
Note the State Department's choice of _pick-pocketings._ Is the doer
...
Finally, Safire comments on _very in the moment:_
...
The thing is: I _hate_ relativism. I hate relativism more than I hate
...
And so does the X-ray vision of the cognitive scientist. "Not speaking the same language" is a virtual synonym for incommensurability,
...
_GO;_ _The_ _spy_ _WHO_ _LOVED_ _ME_ _disappeared;_ _He_ _said_ _THAT_ _SHE_ _LEFT._
...
_BAKED_ _ME_ _A_ _CAKE;_ _She BAKED A_ _CAKE FOR_ _ME;_ _He_ _GAVE_ _HER_ _A_ _PARTRIDGE;_
...
can be inferred: _Yes,_ _**I**_ _can (_ _); Where are you going? (_ _) To the_
_store._
...
_**FORGOT; violet eyes**_ _**TO DIE FOR.**_
...
when the verb refers to an action: _**BELIVEAU**_ _scores;_ _**THE HIPPIE**_ _touched_
_the_ _debutante._
